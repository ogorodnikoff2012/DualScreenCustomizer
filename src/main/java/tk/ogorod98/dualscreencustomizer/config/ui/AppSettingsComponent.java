...
public class AppSettingsComponent implements ActionListener {
	...
	public AppSettingsComponent() {
		ScreenInfoService screenInfoService = ApplicationManager.getApplication().getService(ScreenInfoService.class);

		addEntryButton = new JBOptionButton(new AbstractAction("Add Entry") {
			@Override
		...
		clearEntriesButton.setAction(new AbstractAction("Remove All") {
			@Override
			public void actionPerformed(ActionEvent e) {
				onModify();
				clearScreenSettings();
