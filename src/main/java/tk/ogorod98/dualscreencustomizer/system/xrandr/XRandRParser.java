...
public class XRandRParser {
  ...
  private static final Pattern GEOMETRY_PATTERN =
      Pattern.compile("^(?<width>\\d*)(/\\d*)?x(?<height>\\d*)(/\\d*)?\\+(?<x>\\d*)\\+(?<y>\\d*)$");
    ...
    while (currentLine != null) {
      if (currentLine.startsWith("\t")) {
        ...
        while (currentLine != null
            ...
            && Character.isWhitespace(currentLine.charAt(1))) {
        ...
        while (currentLine != null
            && currentLine.startsWith("  ")
            && Character.isWhitespace(currentLine.charAt(2))) {
